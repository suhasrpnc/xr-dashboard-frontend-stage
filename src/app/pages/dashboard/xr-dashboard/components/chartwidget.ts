    ...
    template: `
        <div class="chart-widget grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="chart-card bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100 dark:border-gray-700">
